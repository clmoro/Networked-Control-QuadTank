function [K,rho,feas]=LMI_DT_SpectRad(F,G,H,N,ContStruc)
...
rho = 0.9; % We constraints all eigs to have radius < rho
if abs(rho)>=1
    disp('The radius constraint is not inside the unitary circle!')
    pause
end
