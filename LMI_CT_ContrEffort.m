function [K,rho,feas]=LMI_CT_ContrEffort(A,B,C,N,ContStruc)
...
% information structure specified by 'ContStruc', with the aim of limiting the control effort. 
%
% Inputs:
% - A: system matrix.
